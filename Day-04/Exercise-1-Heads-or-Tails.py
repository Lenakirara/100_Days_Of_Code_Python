...
Important, the first letter should be capitalised and spelt exactly like in
...
the last lesson, you should generate a random number, either 0 or 1. Then use 
that number to print out Heads or Tails.
